...
### 아무것도 안 했지만, 디스크가 정상적으로 추출되었습니다. 완벽하게.
...
> **아침 9시** — "디스크가 정상적으로 추출되지 않았습니다" 알림 폭탄.
> **오후 3시** — 맥북을 열고, 디스크 우클릭하고, 추출 누르고, SSD 분리하고, 맥북을 가방에 넣고.
> **저녁 11시** — Time Machine 백업, 다시 처음부터.

## 보통의 오늘 (DiskOUT 설치 후)

> **아침 9시** — 알림 0개.
> **오후 3시** — 덮고, 뽑고, 넣고.
> **저녁 11시** — Time Machine 백업, 한 번도 끊김 없이 완료.
