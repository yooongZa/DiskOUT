...
Use the refund or support link in your Paddle receipt, open the purchase details from DiskOUT, or visit [Paddle Buyer Support](https://paddle.net/). Paddle evaluates and processes requests under its [Refund Policy](https://www.paddle.com/legal/refund-policy), its buyer terms, and applicable consumer law.

This policy does not limit any statutory cancellation, withdrawal, conformity, or refund right that applies in your country. Where local law gives you greater or non-waivable rights, those rights apply.

## Effect on Premium access
