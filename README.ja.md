...
### 何もしませんでしたが、ディスクは正しく取り出されました。完璧に。
...
> **朝 9 時** — 「ディスクが正しく取り出されませんでした」通知の嵐。
> **午後 3 時** — Mac を開いて、ディスクを右クリック、取り出しをクリック、SSD を抜いて、Mac を鞄に入れて。
> **夜 11 時** — Time Machine バックアップ、また最初から。

## いつもの今日 (DiskOUT インストール後)

> **朝 9 時** — 通知 0 件。
> **午後 3 時** — 閉じて、抜いて、入れる。
> **夜 11 時** — Time Machine バックアップ、一度も中断なく完了。
